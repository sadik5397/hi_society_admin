...
class CreateBuildingGuardApp extends StatefulWidget {
  const CreateBuildingGuardApp({Key? key, required this.buildingID, required this.buildingName, required this.guard}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: includeDashboard(
            header: "Create Guard App for Building ${widget.buildingName}",
            child: Center(
              ...
              primaryButton(
                  width: 400, title: "Create Building Committee Head Account", onTap: () async => await createCommitteeAccount(accessToken: accessToken, buildingID: widget.buildingID, userID: 15, isHead: "y")),//todo:
              primaryButton(
                  width: 400,
