...
class _ExportDataState extends State<ExportData> {
  ...
  Future<void> readAllBuilding({required String accessToken}) async {
    try {
      ...
      if (result["statusCode"] == 200 || result["statusCode"] == 201) {
        ...
        showError(context: context, label: result["message"][0]
            .toString()
            .length == 1 ? result["message"].toString() : result["message"][0].toString());
      }
  ...
  Future<void> allBuildingsExportToExcel() async {
    ...
    sheet
        ...
        .value = "Building Picture";
    sheet
        .cell(CellIndex.indexByColumnRow(columnIndex: 10, rowIndex: 0))
        .value = "Access Point Email";
    //endregion
    for (int i = 0; i < allBuildingResult.length; i++) {
      //region data
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: i + 1))
          .value = allBuildingResult[i]["buildingId"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: i + 1))
          .value = allBuildingResult[i]["uniqueId"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: i + 1))
          .value = allBuildingResult[i]["buildingName"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 3, rowIndex: i + 1))
          .value = allBuildingResult[i]["address"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 4, rowIndex: i + 1))
          .value = allBuildingResult[i]["approvalStatus"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 5, rowIndex: i + 1))
          .value = allBuildingResult[i]["createdBy"] == null ? "" : allBuildingResult[i]["createdBy"]["name"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 6, rowIndex: i + 1))
          .value = allBuildingResult[i]["createdBy"] == null
          ? ""
      ...
      sheet
          ...
          .value = allBuildingResult[i]["createdBy"] == null ? "" : allBuildingResult[i]["createdBy"]["email"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 8, rowIndex: i + 1))
          .value = allBuildingResult[i]["flats"].length;
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 9, rowIndex: i + 1))
          .value = allBuildingResult[i]["photo"] == null ? "" : '$baseUrl/photos/${allBuildingResult[i]["photo"]}';
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 10, rowIndex: i + 1))
          .value = allBuildingResult[i]["guard"] == null ? "" : allBuildingResult[i]["guard"]["email"].toString();
      //endregion
  ...
  Future<void> allUsersExportToExcel() async {
    ...
    sheet
        .cell(CellIndex.indexByColumnRow(columnIndex: 6, rowIndex: 0))
        .value = "Hi Society Role";
    //endregion
    for (int i = 0; i < allUserResult.length; i++) {
      //region data
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 0, rowIndex: i + 1))
          .value = allUserResult[i]["userId"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 1, rowIndex: i + 1))
          .value = allUserResult[i]["name"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 2, rowIndex: i + 1))
          .value = allUserResult[i]["email"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 3, rowIndex: i + 1))
          .value =
      ...
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 4, rowIndex: i + 1))
          .value = allUserResult[i]["gender"].toString();
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 5, rowIndex: i + 1))
          .value = allUserResult[i]["photo"] == null ? "" : '$baseUrl/photos/${allUserResult[i]["photo"]}';
      sheet
          .cell(CellIndex.indexByColumnRow(columnIndex: 6, rowIndex: i + 1))
          .value = allUserResult[i]["role"] == null ? "" : allUserResult[i]["role"]["role"].toString();
      //endregion
